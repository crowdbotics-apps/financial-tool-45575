"""
Django settings for financial_tool_45575 project.
...
ROOT_URLCONF = 'financial_tool_45575.urls'
...
WSGI_APPLICATION = 'financial_tool_45575.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "financial_tool_45575 API",
    "DESCRIPTION": "API documentation for financial_tool_45575 App",
    "VERSION": "v1",
}
